...
function train(allTexts) {
  ...
  return { texts: allTexts, probabilities: R.map(overTextLength, R.countBy(R.identity, R.pluck("label", allTexts))) };
}
...
module.exports = { _allWords: _allWords, addText: addText, train: train, classify: classify };
