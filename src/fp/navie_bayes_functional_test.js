...
const NB = require("./navie_bayes_functional");

const wish = require("wish");
describe("the file", () => {
  const english = NB.addText(["a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q"], "yes");
  const moreEnglish = NB.addText(["a", "e", "i", "o", "u"], "yes", english);
  const allTexts = NB.addText(["あ", "い", "う", "え", "お", "か", "き", "く", "け", "こ"], "no", moreEnglish);
