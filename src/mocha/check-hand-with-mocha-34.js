...
function allTheSameSuit(suits){
    ...
    suits.forEach(function(suit){
        if(suit !== suits[0]){var wish = require('wish');
        var deepEqual = require('deep-equal');
        ...
        describe('noMultiples()',function(){
            it('reports true when all elements arr different',function(){
                var result = noMultiples(['2','6']);
                wish(result);
            });
        
            it('reports false when all elements arr same',function(){
